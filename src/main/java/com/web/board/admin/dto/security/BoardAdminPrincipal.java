package com.web.board.admin.dto.security;

import com.web.board.admin.domain.constant.RoleType;
import com.web.board.admin.dto.AdminAccountDto;
...
public record BoardAdminPrincipal(
    ...
    /** oAuth2Attributes 인증 했을 경우 (카카오 인증 했을 경우) 사용 */
